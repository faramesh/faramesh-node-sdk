...
exports.canonicalizeActionPayload = canonicalizeActionPayload;
...
function serializeObject(value) {
    ...
    for (const key of keys) {
        if (typeof key !== "string") {
            throw new CanonicalizeError(`Dict keys must be strings, got ${typeof key}: ${key}`);
        }
...
function serializeValue(value) {
    ...
    throw new CanonicalizeError(`Cannot canonicalize value of type ${typeof value}: ${value}`);
}
/**
 ...
 * @throws CanonicalizeError if canonicalization fails
 */
function canonicalizeActionPayload(payload) {
    const cleanPayload = {};
